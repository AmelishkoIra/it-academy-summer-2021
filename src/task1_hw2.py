...
def del_space(string):
    """Функция удаляет из строки повторяющиеся символы и пробелы."""
    string_new = ""
    string = string.lower()
...
def area_triangle(a, b, c):
    """Функция по расчету площади треугольника.
...
def continuous_chain(chain_10):
    """Функция нахождения цепочки нулей.
